    ...
    <form id="certificateForm" class="space-y-8">
      ...
      <section id="step-3" class="hidden space-y-4 mt-6">
        <div class="container" style="background-color: #D9D9D9;">
          <h2 class="text-xl font-semibold fw-bold mt-0">Upload Background</h2>
          <div class="bg-primary bg-opacity-25 text-center p-5 rounded">
            <!-- input untuk mengabil data menggunakan buttonnya, kenapa dua karna drag and drop tidak bisa kebutton ini -->
            <i class="bi bi-upload" style="font-size: 64px;"></i>
            <p class="mt-3 text-muted">Drag and drop image here or</p>
            <label for="uploadInput" class="btn btn-primary">Browse Files</label>
            <!-- input untuk drag and drop -->
            <input type="file" id="uploadInput" name="custom_background" accept="image/*"
      ...
      <div class="flex justify-center gap-4">
        <button type="button" onclick="prevStep()"
          class="px-6 py-2 border border-black text-[#1533B5] rounded">Back</button>
        <button type="button" onclick="nextStep()" class="px-6 py-2 bg-blue-500 text-white rounded">Next</button>
      </div>
  </main>
</body>
